    ...
    if (!loading && posts.length === 0) {
      return (
        <div className="text-center p-8">
          <h3 className="text-xl font-medium mb-2">No posts from followed communities</h3>
          <p className="text-muted-foreground">Join some squads to see content from them!</p>
        </div>
      );
    }
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col">
        <SEOMetaTags 
          title="Following"
          description="Posts from communities you follow on NexaSnap."
          keywords={['following', 'community', 'posts', 'subscriptions']}
        />
