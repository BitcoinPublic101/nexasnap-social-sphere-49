    ...
    if (!loading && posts.length === 0) {
      return (
        <div className="text-center p-8">
          <h3 className="text-xl font-medium mb-2">No popular posts yet</h3>
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col">
        <SEOMetaTags 
          title="Popular Posts"
          description="Discover the most popular content on NexaSnap. Join the conversation today!"
          keywords={['popular', 'trending', 'community', 'top posts']}
        />
